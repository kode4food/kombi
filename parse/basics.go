...
type (
	...
	// Accept receives a any from a Capture Parser
	Accept func(any)

	// Mapper maps one any value to another
	Mapper func(any) any
...
// Bind returns a new Parser, the any of which is based on the any of the
// provided Parser being Combined with the any of the Parser returned by the
// provided Binder
...
// Capture returns a new Parser, the any of which is taken from the supplied
...
// Then returns a new Parser based on the any of the left Parser being
...
// Or returns a new Parser based on either the successful any of the left
// Parser or the any of the right Parser
