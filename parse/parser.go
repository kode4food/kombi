...
// Bind returns a new Parser, the any of which is based on the any of
// this Parser being Combined with the any of the Parser returned by the
// provided Binder
func (p Parser) Bind(b Binder) Parser {
	return Bind(p, b)
}

// Capture returns a new Parser, the any of which is taken from this Parser
// and provided to the Accept function
func (p Parser) Capture(a Accept) Parser {
	return Capture(p, a)
}

// Map returns a new Parser, the any of which is a value generated by the
// provided Mapper
...
// Then returns a new Parser based on the any of this Parser being Combined
// with the results of the other Parser
func (p Parser) Then(other Parser) Parser {
	return Then(p, other)
}

// Or returns a new Parser based on either the successful any of this Parser
// or the any of the other Parser
