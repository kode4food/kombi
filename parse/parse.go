...
// OneOrMore returns a new Parser, the Result of which is the
// Combined set of values matched by the provided Parser being
// performed one or more times
func (p Parser) OneOrMore() Parser {
	return OneOrMore(p)
}

// ZeroOrMore returns a new Parser, the Result of which is the
// Combined set of values matched by the provided Parser being
